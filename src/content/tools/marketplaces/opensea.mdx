...
i18n:
  en:
    title: "OpenSea"
    description: OpenSea is the world's leading NFT marketplace for discovering, collecting, and trading digital collectibles, with a wide range of unique art and collections"
    features:
